...
<div id="block-blog-form">
	...
	<form name="submit-comment" action="sites/scripts/submit_comment.php?src=gallery&loc=block-blog-form" method="POST">
		<input type="hidden" id="collection" name="collection" value="gallery" />
